...
SVGElement.prototype = {
	...
	attr: function (hash, val) {
		...
		// setter
			...
			// Update transform. Do this outside the loop to prevent redundant updating for batch system
			// of attributes.
			if (doTransform) {
	...
	*/
	...
	css: function (styles) {
		...
		if (isIE && !hasSVG) { // legacy IE doesn't support system style attribute
			if (textWidth) {
				delete styles.width;
			}
...
SVGRenderer.prototype = {
	...
	label: function (str, x, y, shape, anchorX, anchorY, useHTML, baseline, className) {
		...
		/**
		 * This function runs after system text or padding, but only if padding is changed
		 */
		...
		attrSetters.align = function (value) {
			...
			return false; // prevent system text-anchor on the group
		};
...
var VMLRendererExtension = { // inherit SVGRenderer
	 ...
	 * for system the CSS style to all associated members.
	 *
	 * @param {Number} x
	 * @param {Number} y
	 * @param {Number} width
...
Series.prototype = {
	...
	invertGroups: function () {
		...
		// On subsequent render and redraw, just do setInvert without system up events again
